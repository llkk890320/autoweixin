...
import com.aipin.wx.autowx.utils.enums.MsgCodeEnum;
...
public class MsgCenter {
	 ...
	 * @param msgHandler
	 */
	public static void handleMsg(IMsgHandler msgHandler,Core core,MessageTools messageTool) {
					...
					if (msg.getType() != null) {
						try {
							if (msg.getType().equals(MsgTypeEnum.TEXT.getType())) {
								...
								messageTool.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
								...
								messageTool.sendMsgById(result,
